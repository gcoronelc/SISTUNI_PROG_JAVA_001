...
public class PedidoService {
  ...
  public double importeTotal(double importe,double cantidad){
  double total;
  
  total=( importe+ calcularImpuesto(importe))* cantidad;
  
  return total;
  }
  
  public double impuestoTotal(double importe,double cantidad){
  double impuesto;
  
  impuesto=calcularImpuesto(importe)*cantidad;
