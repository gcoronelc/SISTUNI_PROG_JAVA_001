...
public class MainView extends javax.swing.JFrame {
  ...
  private void cargarFormulario(Class<?> aClass) {
    try {
      ...
      // Verificar si ya se tiene en el desktopPane un
      // formulario cargado según el tipo del parámetro.
      // Si encuentra uno la variable view apunta a ese
      /// objeto, caso contrario view seguira siendo null.
